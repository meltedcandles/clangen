...
for a, i in enumerate(
    ...
    sprites.make_group('eyesmelt', (a, 0), f'eyes{i}')
    sprites.make_group('eyesmeltextra', (a, 0), f'eyesextra{i}', sprites_y=2)
    sprites.make_group('eyesmelt2', (a, 0), f'eyes2{i}')
    sprites.make_group('eyesmelt2extra', (a, 0), f'eyes2extra{i}', sprites_y=2)
for a, i in enumerate(
        ['DARKVIBRANTGREEN', 'PINKGREY', 'SAND', 'AUTUMN', 'LEAF', 'SUNSETBEACH']):
    sprites.make_group('eyesmelt', (a, 1), f'eyes{i}')
    sprites.make_group('eyesmeltextra', (a, 1), f'eyesextra{i}', sprites_y=2)
    sprites.make_group('eyesmelt2', (a, 1), f'eyes2{i}')
    sprites.make_group('eyesmelt2extra', (a, 1), f'eyes2extra{i}', sprites_y=2)
for a, i in enumerate(
        ['ROYALPURPLE', 'PLUM', 'VIBRANTGREEN2', 'GRASS', 'VIBRANTGREENRASPBERRY', 'VIBRANTGREENAUTUMN']):
    sprites.make_group('eyesmelt', (a, 2), f'eyes{i}')
    sprites.make_group('eyesmeltextra', (a, 2), f'eyesextra{i}', sprites_y=2)
    sprites.make_group('eyesmelt2', (a, 2), f'eyes2{i}')
    sprites.make_group('eyesmelt2extra', (a, 2), f'eyes2extra{i}', sprites_y=2)
for a, i in enumerate(
        ['LIGHTBERRY', 'SUGARGRAPE', 'PINK']):
    sprites.make_group('eyesmelt', (a, 3), f'eyes{i}')
    sprites.make_group('eyesmeltextra', (a, 3), f'eyesextra{i}', sprites_y=2)
    sprites.make_group('eyesmelt2', (a, 3), f'eyes2{i}')
    sprites.make_group('eyesmelt2extra', (a, 3), f'eyes2extra{i}', sprites_y=2)
