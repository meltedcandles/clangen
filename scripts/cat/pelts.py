...
little_white = ['LITTLE', 'BLACKLITTLE' 'LITTLECREAMY', 'LIGHTTUXEDO', 'BLACKLIGHTTUXEDO', 'BUZZARDFANG', 'BLACKBUZZARDFANG', 'TIP',
    'BLACKTIP', 'BLAZE', 'BLACKBLAZE', 'BIB', 'BLACKBIB', 'VEE', 'BLACKVEE', 'PAWS', 'BLACKPAWS' 
    'BELLY', 'BLACKBELLY', 'TAILTIP', 'BLACKTAILTIP', 'TOES', 'BLACKTOES', 'BROKENBLAZE', 'BLACKBROKENBLAZE', 'LILTWO', 'BLACKLILTWO',
    'SCOURGE', 'BLACKSCOURGE', 'TOESTAIL', 'BLACKTOESTAIL', 'RAVENPAW', 'BLACKRAVENPAW', 'HONEY', 'BLACKHONEY']
mid_white = ['TUXEDO', 'BLACKTUXEDO', 'TUXEDOCREAMY', 'FANCY', 'BLACKFANCY', 'UNDERS', 'BLACKUNDERS', 'DAMIEN', 'BLACKDAMIEN',
    'SKUNK', 'BLACKSKUNK', 'MITAINE', 'BLACKMITAINE', 'SQUEAKS', 'BLACKSQUEAKS', 'STAR', 'BLACKSTAR']
high_white = ['ANY', 'BLACKANY', 'ANYCREAMY', 'ANY2', 'BLACKANY2', 'ANY2CREAMY', 'BROKEN', 'BLACKBROKEN', 'FRECKLES', 'BLACKFRECKLES',
    'RINGTAIL', 'BLACKRINGTAIL', 'HALFFACE', 'BLACKHALFFACE', 'PANTS2', 'BLACKPANTS2',
    'GOATEE', 'BLACKGOATEE', 'PRINCE', 'BLACKPRINCE', 'FAROFA', 'BLACKFAROFA', 'MISTER', 'BLACKMISTER', 'PANTS', 'BLACKPANTS',
    'REVERSEPANTS', 'BLACKREVERSEPANTS', 'HALFWHITE', 'BLACKHALFWHITE', 'APPALOOSA', 'BLACKAPPALOOSA', 'PIEBALD', 'BLACKPIEBALD',
    'CURVED', 'BLACKCURVED', 'GLASS', 'BLACKGLASS', 'MASKMANTLE', 'BLACKMASKMANTLE']
mostly_white = ['VAN', 'BLACKVAN', 'VANCREAMY', 'ONEEAR', 'BLACKONEEAR', 'LIGHTSONG', 'BLACKLIGHTSONG', 'TAIL', 'BLACKTAIL', 'HEART',
    'BLACKHEART', 'MOORISH', 'BLACKMOORISH', 'APRON', 'BLACKAPRON', 'CAPSADDLE', 'BLACKCAPSADDLE']
point_markings = ['COLOURPOINT', 'BLACKCOLOURPOINT', 'COLOURPOINTCREAMY', 'RAGDOLL', 'BLACKRAGDOLL', 'KARPATI', 'BLACKKARPATI']
vit = ['VITILIGO', 'BLACKVITILIGO', 'VITILIGO2', 'BLACKVITILIGO2']
white_sprites = [
    little_white, mid_white, high_white, mostly_white, point_markings, vit, 'FULLWHITE', 'FULLBLACK', 'EXTRA', 'POINTMARK', 'WHITEPOINTMARK'
]
